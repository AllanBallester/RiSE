...
function onPlaceChanged() {
  ...
  // $('#homeless_location').trigger('blur').val(components.location);
  $('#homeless_zip_code').val(components.zip_code);
  $('#homeless_city').val(components.city);
  if (components.country_code) {
    $('#homeless_country').val(components.country_code);
  }
}

function getLocationComponents(place) {
  ...
  for (var i in place.location_components) {
    var component = place.location_components[i];
